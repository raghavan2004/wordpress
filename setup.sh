...
wp core install --url="http://$domain" --title="WordPress Site" --admin_user="admin" --admin_password=$admin_pass --admin_email=$email-id --allow-root
